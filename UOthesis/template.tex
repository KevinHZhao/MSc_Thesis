...
\begin{filecontents*}{\jobname.xmpdata}
                                \Title{\textbf{TriLLIEM}: Triad Log-Linear modelling of Imprinting, Environmental interactions, and Maternal effects}
  \Author{Kevin Zhao}
...
\documentclass[12pt,Nomencl]{UOthesis}
...
\setUOtitle{\textbf{TriLLIEM}: Triad Log-Linear modelling of Imprinting, Environmental interactions, and Maternal effects}  % Title of the thesis
