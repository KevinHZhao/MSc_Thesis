...
cat(
  kbl(reject_table %>%
      ...
      caption = "Rejection rates at $\\alpha < 0.05$ for simulated data sets without controls where $\\EE = 0.3$, where the environmental interaction parameter is $I_{\\MM}$.  S and NS stand for the stratified and non-stratified approaches for gene-environment interactions, respectively.  The MaS column represents the value of the mating asymmetry coefficients used during simulation.  To see the scenario conditions, please use the ID column to refer to the appropriate row of \\cref{tab:conditions}.  Results from data simulated with MaS coefficients of $1.15$ are omitted for brevity.",
      digits = 5,
      ...
      longtable = TRUE,
      linesep = c("", "", "\\addlinespace"),
      caption.short = "Rejection rates for $I_{\\MM}$ models without controls.",
      position = "H") %>%
    kable_styling(latex_options=c("repeat_header", "hold_position"),
                  repeat_header_method = "replace")#%>%
  #column_spec(column = c(2, 5, 6), width = c("1.5in", "0.8in", "0.6in"))
...
cat(
  kbl(reject_table %>%
      ...
      align = "l",
      col.names = c("ID", "$\\CC$", "$\\MM$", "$\\EE:I_{\\FF}$", "$I_{\\FF}$", "MT", "$\\EE$ approach", "True effect", "MaS"),
      caption = "Rejection rates at $\\alpha < 0.05$ for simulated data sets with controls where $\\EE = 0.3$, where the environmental environmental interaction paramter is $I_{\\FF}$.  S and NS stand for the stratified and non-stratified approaches for gene-environment interactions, respectively.  The MaS column represents the value of the mating asymmetry coefficients used during simulation.  To see the scenario conditions, please use the ID column to refer to the appropriate row of \\cref{tab:conditions}.  Results from data simulated with MaS coefficients of $1.15$ are omitted for brevity.",
      digits = 5,
      label = "reject_eif_c",
      escape = FALSE,
      booktabs = TRUE,
      longtable = TRUE,
      linesep = c("", "", "\\addlinespace"),
      caption.short = "Rejection rates for $I_{\\FF}$ models with controls.",
      position = "H") %>%
    kable_styling(latex_options=c("repeat_header", "hold_position"),
                  repeat_header_method = "replace")#%>%
  #column_spec(column = c(2, 5, 6), width = c("1.5in", "0.8in", "0.6in"))
...
cat(
  kbl(reject_table %>%
      ...
      align = "l",
      col.names = c("ID", "$\\CC$", "$\\MM$", "$\\EE:I_{\\MM}$", "$I_{\\MM}$", "MT", "$\\EE$ approach", "True effect", "MaS"),
      caption = "Rejection rates at $\\alpha < 0.05$ for simulated data sets with controls where $\\EE = 0.3$, where the environmental interaction paramter is $I_{\\MM}$.  S and NS stand for the stratified and non-stratified approaches for gene-environment interactions, respectively.  The MaS column represents the value of the mating asymmetry coefficients used during simulation.  To see the scenario conditions, please use the ID column to refer to the appropriate row of \\cref{tab:conditions}.  Results from data simulated with MaS coefficients of $1.15$ are omitted for brevity.",
      digits = 5,
      label = "reject_eim_c",
      escape = FALSE,
      booktabs = TRUE,
      longtable = TRUE,
      linesep = c("", "", "\\addlinespace"),
      caption.short = "Rejection rates for $I_{\\MM}$ models with controls.",
      position = "H") %>%
    kable_styling(latex_options=c("repeat_header", "hold_position"),
                  repeat_header_method = "replace")#%>%
  #column_spec(column = c(2, 5, 6), width = c("1.5in", "0.8in", "0.6in"))
  ...
  reject_table %>%
    ...
    mutate(effects = get_true_effects(conditions = conditions, id = rowid),
           strat = case_when(strat == "noE" ~ "no $\\EE$",
                             strat == "strat" ~ "S",
                             strat == "nostrat" ~ "NS")),
  "fulltables/full_reject_table.csv"
)
